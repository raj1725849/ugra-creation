...
const cardVariants = cva("absolute will-change-transform", {
  variants: {
    variant: {
      dark: "flex size-full flex-col items-center justify-center gap-6 rounded-[4px] border border-stone-700/50 bg-charcoal p-6 md:p-10 backdrop-blur-md shadow-xl",
      light:
        "flex size-full flex-col items-center justify-center gap-6 rounded-[4px] border border-gold-light/20 bg-cream p-6 md:p-10 backdrop-blur-md shadow-xl",
    },
  },
  defaultVariants: {
    variant: "light",
